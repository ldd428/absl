...
#include "absl/synchronization/internal/mutex_nonprod.h"
...
void Mutex::Lock() { impl1()->Lock(); }

void Mutex::Unlock() { impl1()->Unlock(); }

bool Mutex::TryLock() { return impl1()->TryLock(); }

void Mutex::ReaderLock() { Lock(); }

void Mutex::ReaderUnlock() { Unlock(); }

void Mutex::Await(const Condition& cond) { impl1()->Await(cond); }
...
bool Mutex::AwaitWithDeadline(const Condition& cond, absl::Time deadline) {
  return impl1()->AwaitWithDeadline(
...
void CondVar::Signal() { impl1()->Signal(); }

void CondVar::SignalAll() { impl1()->SignalAll(); }

void CondVar::Wait(Mutex* mu) { return impl1()->Wait(mu->impl1()); }

bool CondVar::WaitWithDeadline(Mutex* mu, absl::Time deadline) {
  return impl1()->WaitWithDeadline(
      mu->impl1(), synchronization_internal::LimitedDeadline(deadline));
}
