...
#include "absl/time/internal/get_current_time_ios.h"
#elif defined(_WIN32)
#include "absl/time/internal/get_current_time_windows.h"
#else
#include "absl/time/internal/get_current_time_posix.h"
#endif
